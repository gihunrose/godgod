...
타임아웃이 자주 나면 아래 값을 추가할 수 있습니다. 기본값은 25초입니다.
...
`TIMEOUT` 또는 `NETWORK` 오류는 코레일 응답 지연, Streamlit Cloud의 외부 접속 경로 문제, 일시적 차단 때문에 생길 수 있습니다. 이 오류가 3회 연속 발생하면 앱은 자동으로 중지됩니다.
